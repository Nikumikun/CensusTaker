...
Функция СоздатьЗапись(ЧислоЗаписей)
	...
	АдресСправочник.Код = ЧислоЗаписей+1;
	...
	ВопросыСправочник.Код = ЧислоЗаписей+1;
	...
	ПерсональныеДанныеСправочник.Код = ЧислоЗаписей+1;
	...
	СемьяСправочник.Код = ЧислоЗаписей+1;
	...
	СтранаСправочник.Код = ЧислоЗаписей+1;
	...
	РаботаСправочник.Код = ЧислоЗаписей+1;
	...
	ОбразованиеСправочник.Код = ЧислоЗаписей+1;
	...
	СоциальныеДанныеСправочник.Код = ЧислоЗаписей+1;
	...
	ГражданинСправочник.Код = ЧислоЗаписей+1;

...
Процедура Выгрузить(Команда)
	...
	Иначе
		Выгрузка();
		Сообщить("Выгрузка завершена, проверьте C:\Users\Public\Documents\export.txt");
		КонецЕсли;
КонецПроцедуры
...
Функция Выгрузка()
	...
	Текст = Новый ЗаписьТекста("C:\Users\Public\Documents\export.txt", КодировкаТекста.ANSI);
